...
<img src="assets/banner.gif" alt="unsnooze — wakes every limit-stopped AI session the moment the limit resets" width="880"/>
...
<img src="assets/demo.gif" alt="terminal demo: limit banners detected in two sessions, unsnooze waits for the reset, then wakes both — good morning, the work is done" width="880"/>
